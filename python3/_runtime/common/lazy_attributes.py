...
def _private():
        ...
        class _Meta(type):
            ...
            def __init__(cls, *args, **kwargs):
                ...
                def _make_default_dictionary():
                    def _factory(module: type(_module), name: str): return importlib.import_module(
                        "{}.{}".format(_module_name, name)
                    )
    ...
    return _property_collector_module.make(Base = _Base, make_class = _make_class, make_getter = _make_getter)
